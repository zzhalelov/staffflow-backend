...
//        long positionId = 1L;
//
//        LaborContractCreateDto createDto = new LaborContractCreateDto();
...
//        createDto.setHireDate(LocalDate.of(2026, 1, 1));
//        createDto.setLaborContractStatus(LaborContractStatus.NOT_SIGNED);
//
//        Mockito
//                .when(laborContractService.create(Mockito.any(LaborContract.class)))
//                .thenAnswer(i -> {
//                    LaborContract argument = i.getArgument(0, LaborContract.class);
//                    argument.setId(laborContractId);
//                    return argument;
//                });
//
